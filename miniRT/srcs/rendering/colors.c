...
/*   Updated: 2025/07/03 23:32:27 by antonsplavn      ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
                               ...
                               double specular_intensity)
{
    ...
    float exposure = 0.3f; // try values from 1.0 to 2.0 or more
 ...
 *
 * (Simple)
 * Direct RGB arithmetic
 * No color space conversion
 * Simple 0-255 clamping
